...
// Layer definitions with label, color, and sample content
const layers = [
  {
    label: "Artificial Intelligence",
    color: "#2d3748",
    content: [
      "PyTorch", "TensorFlow", "OpenAI", "Scikit-Learn"
    ]
  },
  {
    ...
    color: "#4a5568",
    content: [
      "XGBoost", "LightGBM", "Keras", "CatBoost"
    ]
  },
  {
...
function ConcentricCircles() {
  // Tracks which layer is currently "expanded"
  const [expanded, setExpanded] = useState(0);

  // Handles scroll to progress through layers
  React.useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <Wrapper>
      <h1 style={{
        ...
        AI Startup: Dynamic Tech Domains
      </h1>
      <ConcentricCircles />
      <div style={{
        color: "#bce0f7",
        ...
        Scroll down to explore expertise across all AI technology areas—see the journey converge as you reach the end!
      </div>
      <div style={{ height: "180vh" }} /> {/* For scrolling */}
    </Wrapper>
  );
}
